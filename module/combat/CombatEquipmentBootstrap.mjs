...
import {
	COMBAT_DEFENCE_RESPONSE,
	CombatDefenceOpportunity,
} from "./CombatDefenceOpportunity.mjs";
...
Hooks.once("init", () => {
	...
	game.WFRP1ED = Object.freeze({
		...
		combat: Object.freeze({
			...
			defence: CombatDefenceOpportunity,
			defenceResponse: COMBAT_DEFENCE_RESPONSE,
		}),
