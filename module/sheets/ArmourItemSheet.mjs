...
function corePieceOptions() {
	return [
		...
		[ARMOUR_PIECE.LEATHER_COIF, localize("Leather coif", "Czepiec skórzany")],
		[ARMOUR_PIECE.LEATHER_JERKIN, localize("Leather jerkin", "Kaftan skórzany")],
		[ARMOUR_PIECE.LEATHER_JACKET, localize("Leather jacket", "Kurtka skórzana")],
		...
		[ARMOUR_PIECE.BACK_PLATE, localize("Back plate", "Naplecznik")],
		...
		[ARMOUR_PIECE.GAUNTLETS, localize("Gauntlets", "Rękawice")],
		[ARMOUR_PIECE.LEGGINGS, localize("Leggings", "Nagolennice")],
		[ARMOUR_PIECE.HELMET, localize("Knight's helm", "Hełm rycerski")],
		[ARMOUR_PIECE.POT_HELMET, localize("Pot helmet", "Hełm otwarty")],
